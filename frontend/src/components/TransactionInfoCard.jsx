import { Trash2, TrendingUp, TrendingUpDown, UtensilsCrossed } from 'lucide-react'
import React from 'react'
import { addThousandsSeparator } from '../util/util'

function TransactionInfoCard({icon, title, date, type, amount, hideDeleteBtn, onDelete}) {
